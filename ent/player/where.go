...
func ColorEQ(v Color) predicate.Player {
	return predicate.Player(func(s *sql.Selector) {
...
func ColorNEQ(v Color) predicate.Player {
	return predicate.Player(func(s *sql.Selector) {
...
func ColorIn(vs ...Color) predicate.Player {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ColorNotIn(vs ...Color) predicate.Player {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
